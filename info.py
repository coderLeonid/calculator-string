...
text_help_calc = ("Строка-калькулятор. Быстрый ввод • мгновенное вычисление • точный ответ\n\n"
                  ...
                  " ⬥ Знак умножения проставляется автоматически, при курсором после π подставится деление (удобно вводить радианные углы 'k•π/m')\n"
                  ...
                  " ★ Скорость: быстрый ввод примера\n"
                  " ★ Корректность: посчитает даже выражениями вида (-32)^(3/5), (-5.2)!, (-11)mod(-3)\n"
                  " ★ Точность: сверхточное вычисление тригонометрических и логарифмических функций\n"
                  " ★ Гибкость: учёт недостающих символов '2+2)•3•|1+1' → '(2+2)•3•|1+1|', '5+-4' → '5+(-4)'\n"
                  " ★ Краткость: удаление лишних скобок и модулей при добавлении в историю '(|(2+2)|•3' → '|2+2|•3'\n"
                  " ★ Разумность: автоматичское добавление скобок, модулей, знака умножения, нуля перед точкой, скобок перед минусом при вводе\n"
                  " ★ Адаптивность: раскладка меняется на английскую на время фокусировки на приложении, потом возвращается на предыдущую\n"
                  " ★ Внимательность: если калькулятор не считал примеры уже 2 недели, он подскажет, как открыть инструкцию применения\n"
                  " ★ Сохранность: откроешь калькулятор за 15 секунд после случайного закрытия — пример останется. Иначе перейдёт в историю, а если в ответе не число — вовсе удалится\n"
                  "\nНастройки и вид\n"
