...
text_help_calc = ("Строка-калькулятор. Быстрый ввод • мгновенное вычисление • точный ответ\n\n"
                  ...
                  " ⬥ 3 нуля [z] (zeros — нули), [M] — 6 нулей (million), [B] — 9 (billion), [T] — 12 (trillion), [Q] — 15 (quadrillion)\n"
                  ...
                  " ⬥ При вводе клавиш после любого знака или в начале строки, [•] будет идти в комплекте с символом '2'; [/] с '1', а после '•' — '-1', после '√' — '3';\n"
                  ...
                  " ⚙ Округление. По умолчанию: пиши где угодно в примере q, до нужного знака: qA (A — число от -23 до 17) и оно автоматически применится через секунду\n"
                  " ⚙ Чтобы настроить размер памяти истории напишите hx#, где x — максимальное число примеров\n"
                  " ⚙ Тема. Чтобы поменять тему со светлой на тёмную или с тёмной на светлую, нажми ctrl+t (theme)\n"
                  " ⚙ Размер текста. Увеличивай строку комбинацией [ctrl]+[+], уменьшай через [ctrl]+[-]\n"
                  " ⚙ Разворачивай и сворачивай строку комбинациями ctrl+↑ и ctrl+↓\n"
